...
const HOLIDAYS = [
    ...
    // --- 2027 年 (預先部屬) ---
    "2027-01-01", // 元旦
    "2027-02-05", "2027-02-06", "2027-02-07", "2027-02-08", "2027-02-09" // 2027過年預估
];

// 定義補班日 (週六但算平日價的日子)
// 注意：如果您的營區「所有週六」一律算假日價，這裡請留空 [] 即可。
// 2026 補班日預估：2/7(六) 補 2/16 的假? 
const MAKEUP_DAYS = [
    "2026-02-07", // 補春節
    "2026-02-21"  // 預留備用
];
